...
async function bootstrap() {
  ...
  console.log('PGDATABASE (Railway):', process.env.PGDATABASE || process.env.PGDAT || 'NOT SET');
  ...
  console.log('PGPASSWORD (Railway):', (process.env.PGPASSWORD || process.env.PGPASS) ? 'SET' : 'NOT SET');
